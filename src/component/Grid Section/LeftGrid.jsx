      ...
      <div className="middle-pro" style={{ padding: "2.5vh" }}>
        ...
        <div className="listpro " style={{ color: "darkgrey" }}>
          <p>
            ...
            Proficient in Firebase for real-time databases, authentication, and
            cloud functions.
          </p>
          <p>
            {" "}
          ...
          <p>
            {" "}
            <FaCheck style={{ color: "#e3882d", marginRight: "4px" }} />
            Skilled in working with GraphQL for efficient API development and
            data querying.
          </p>
          <p>
            {" "}
          ...
          <p>
            {" "}
            <FaCheck style={{ color: "#e3882d", marginRight: "4px" }} />
            Proficient in using Linux for server administration and development
            tasks.
          </p>
          <p>
            {" "}
